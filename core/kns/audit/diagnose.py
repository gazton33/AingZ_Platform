...
This module reads ``baseline.csv`` in the repository root and assigns a
category to every entry based on file extension. It then writes a Markdown
report grouping the entries by their categories.
"""
